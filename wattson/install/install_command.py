...
from wattson.install.component_install import ComponentInstall, InstallOperation
from wattson.install.components.apt_install import AptInstall
from wattson.install.components.containernet_install import ContainernetInstall
from wattson.install.log_screen import LogScreen
...
class WattsonInstallDependencies:
